...
tabtitle = 'xkcd'
list_of_options=['this is a cat!', 'correlation', 'git commit', 'scatterplot']
list_of_images=['catinabox.jpg', 'correlation.png', 'gitcommit.jpg', 'scatterplot.png', 'good_code.png']
